...
const cantidadViajesAgregados = document.getElementById(
  "cuantos-viajes-agregados"
); // revisar
...
const formularioCheckout = document.querySelector(
...
const contenedorDeTodasLasFotos = document.querySelectorAll(
  ".contenedor-img-tarjeta"
);
const contenedorDeLaInfo = document.querySelectorAll(
  ...
  let miniaturaViajeHTML = `
    <div class="contenedor-viaje-miniatura">
        <div class="contenedor-img-miniatura">
            <img class="img-tarjeta-miniatura" src="${
              viajeReservado.dataset.imagen
            }">
        </div>
        ...
        <div class="contenedor-info-miniatura">
            <div class="sub-contenedor-info-miniatura">
                ...
                id="id-trash-miniatura" value="${
                  viajeReservado.dataset.destino
                }" tabIndex="2">
            </div>
            ...
            <div class="sub-contenedor-info-miniatura">
                ...
                <p class="precio-viaje-miniatura">x $<span>${
                  viajeReservado.dataset.precio
                }<span></p>
            </div>
        </div>
    </div>
...
const agregaMiniaturasDeViajesElegidos = () => {
  if (viajesEnReserva.length === 0) {
    ...
    for (let viajeReservado of viajesEnReserva) {
      todosLosViajesHTML =
        todosLosViajesHTML + crearMiniaturaViaje(viajeReservado);
    }
...
botonConfirmaVaciar.onclick = () => {
  ...
  eliminaMiniaturasDeViajesElegidos(); 
  cerrarCarrito.setAttribute("tabIndex", 1);
};
...
const pasaTodosLosFiltros = (viaje) => {
  if (
    pasaFiltroInput(viaje) &&
    pasaFiltroCategoria(viaje) &&
    pasaFiltroStars(viaje)
  ) {
